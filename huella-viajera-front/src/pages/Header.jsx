  ...
  return (
    <div className="bg-cyan h-28 flex shadow-lg drop-shadow-lg">
          ...
          <div className="w-[350px]">
            <img className="h-36 w-56 bg-logo bg-center shadow-lg mx-auto" src={logo} alt="logo" />
          </div>
          ...
          <ul className="flex gap-8 mr-24 hover:cursor-pointer">
            ...
            <li className="hover:border-b text-white text-xl">Encontrar cuidador</li>
       ...
       <div className="relative">
          <div className=" p-2 rounded-lg  flex items-center gap-4">
            ...
            <div className="h-10 rounded-xl bg-white border border-gray-300 shadow-lg flex justify-between items-center p-4 text-xs text-gray-600 hover:cursor-default">
              <h1 className=" font-normal">{userData.role === "ownerPet" ? "Dueño de Mascotas" : "Cuidador"}</h1>
            ...
            <div className="bg-white absolute w-full right-0 p-8 mt-2 flex flex-col justify-center gap-4 rounded-lg text-left shadow-lg hover:cursor-default">
              ...
              <div>
                <h1>Mi Perfil</h1>
                <p className="text-sm font-normal hover:cursor-pointer" id="profile" onClick={selected}>Ver</p>
              </div>
              <div>
              <h1>Anuncios</h1>
                <p className="text-sm font-normal hover:cursor-pointer" id="posting" onClick={selected}>Mis anuncios</p>
              </div>
              
              <h1 className="font-bold hover:cursor-pointer mt-4" onClick={sessionClose}>Cerrar Sesion</h1> 
            </div>
